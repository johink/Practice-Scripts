...
#Tree Orders
"""
This script is a modified version of the starter file provided for the course
I was unable to get my script to pass the unit tests, but using the provided
recursion and stack options in a separate thread it was finally successful.
"""
class Tree(object):
